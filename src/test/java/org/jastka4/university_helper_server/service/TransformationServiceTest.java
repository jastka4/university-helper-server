package org.jastka4.university_helper_server.service;
...
class TransformationServiceTest {
    ...
    @Test
    void transformCalendarJson() {
        final String output = transformationService.transformJson(calendarJsonInput, "calendar");
